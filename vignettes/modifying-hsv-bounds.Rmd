...
The default values for the HSV-spectra provided via the shiny-application are set in the backend-package "[duflor](https://github.com/Claudius-Appel/duflor)", **not frontend-package "[duflor.gui](https://github.com/Claudius-Appel/duflor.gui)"**.
