...
![Fig. 2: First three steps required to restrict search-range for the quantification of the identifier-dot.](../man/figures/limit_identifier_workflow_steps.png){alt="Fig. 2: First three steps required to restrict search-range for the quantification of the identifier-dot."}

![Fig. 3: Final step required to restrict search-range for the quantification of the identifier-dot](../man/figures/selecting_area_of_identifier_dot.png){alt="Fig. 3: Final step required to restrict search-range for the quantification of the identifier-dot"}
